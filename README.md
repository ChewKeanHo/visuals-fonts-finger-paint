# Finger Paint Font | (Holloway) Chew, Kean Ho's Creative Visuals

[![banner](/Pictures/banner_1200x630.svg)](#)

Finger Paint is a Latin (ID: `*Latn`) Handwriting font designed by
[The Finger Paint Project Team](https://github.com/librefonts/FingerPaint).
Its design is based on actual finger painting on a surface creating a natural
handwritten doddled text presentation.
...
Creators: The Finger Paint Project Team
Packaged-By: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-fonts-finger-paint
UUID: DA9E65F1-01A6-4E85-A576-7F0B35577795
...
Procure: https://github.com/ChewKeanHo/visuals-fonts-finger-paint
```
